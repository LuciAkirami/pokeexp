...
import XpInputBlock from '@/components/common/XpInputBlock'; // Adjusted path
...
export default function XPInputTabs({ inputs, handleNumberInput, theme }: XPInputTabsProps) {
